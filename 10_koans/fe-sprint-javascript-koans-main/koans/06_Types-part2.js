 ...
 */
  ...
  it('원시 자료형을 변수에 할당할 경우, 값 자체의 복사가 일어납니다.', function () {
    let overTwenty = true;
    let allowedToDrink = overTwenty;  //true
    ...
    let variableCopy = 'variableCopy'; //'variable'
  ...
  */
  ...
  it('참조 자료형을 변수에 할당할 경우, 데이터의 주소가 저장됩니다.', function () {
    ...
    */
    ...
    let allowedToDrink = overTwenty; //['hongsik', 'minchul', 'hoyong'];

    overTwenty.push('san'); //['hongsik', 'minchul', 'hoyong','san'];

describe('Object에 대해서 학습합니다.', function () {
  ...
  */
  ...
  it("'this'는 method를 호출하는 시점에 결정됩니다.", function () {
    ...
    //<new Date() 예시> const date1 = new Date('December 17, 1995 03:24:00');
    // Sun Dec 17 1995 03:24:00 GMT..
    //<getfullYear() 예시> const moonLanding = new Date('July 20, 69 00:20:18');
    //console.log(moonLanding.getFullYear());  --년도 값을 가져옴
    ...
    //안쪽에서 birthYear에 대해 재할당을 해서 값을 바꿔줌
  ...
  it('Object를 함수의 전달인자로 전달할 경우, reference가 전달됩니다.', function () {
    const obj = {
      mastermind: 'Joker',    
      henchwoman: 'Harley',   //139 줄 실행 'Adam West'  -- 152 줄 실행 'Harley'
      relations: ['Anarky', 'Duela Dent', 'Lucy'],
      twins: {
        'Jared Leto': 'Suicide Squad',
        'Joaquin Phoenix': 'Joker',
    ...
    깊은 클로닝에 대해서, Object.assign() 은 속성의 값을 복사하기때문에 다른 대안을 사용해야합니다. 
